...
- [ ] Create migration for ff_field_sets table
...
- [ ] Create migration for ff_set_fields table
...
- [ ] Create migration to add field_set_code column to ff_values
...
- [ ] Create data migration script for shapes to field sets
...
- [ ] Create FieldSet model (src/Models/FieldSet.php)
...
- [ ] Create SetField model (src/Models/SetField.php)
  - Define table, guarded=[], casts
...
- [ ] Create FieldSetNotFoundException exception
  - Extend base exception
  - Include set_code and model_type in message

- [ ] Create FieldSetInUseException exception
  - Extend base exception
  - Include set_code and count of instances using it

- [ ] Create FieldNotInSetException exception
  - Extend base exception
...
- [ ] Add field set management methods to Flexy trait
...
- [ ] Add field set method signatures to FlexyModelContract
...
- [ ] Write unit tests for FieldSet model
...
- [ ] Write unit tests for SetField model
  - Test creation, retrieval, deletion
  - Test field metadata storage
  - Test relationships

- [ ] Write integration tests for field set assignment
...
- [ ] Write edge case tests - Concurrent Modifications
...
- [ ] Write edge case tests - Field Set Deletion
...
- [ ] Write edge case tests - Field Set Assignment
...
- [ ] Write edge case tests - Field Values
...
- [ ] Write edge case tests - Validation
...
- [ ] Write edge case tests - Migration
...
- [ ] Write edge case tests - Performance
...
- [ ] Write edge case tests - Data Integrity
...
- [ ] Write edge case tests - Metadata
...
- [ ] Write test for code coverage edge cases
